...
namespace Vetero.Persistance.Migrations
{
    ...
    [Migration("20230703175211_UpdateColumnNames")]
            ...
            modelBuilder.Entity("Vetero.Domain.Entities.WeatherData.WeatherStationData", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataDate = new DateTime(2023, 7, 3, 19, 52, 10, 805, DateTimeKind.Local).AddTicks(4575),
                            Humidity = 20.0,
                            Pressure = 34.82,
                            Sunrise = 7.0,
                            Sunset = 19.0,
                        ...
                        {
                            Id = 2,
                            DataDate = new DateTime(2023, 7, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            Humidity = 22.0,
                            Pressure = 34.82,
